...
import PoliceInsAudit from '../Mutations/PoliceInsAudit'
...
const { Option } = Select;
const query = graphql`
query Depauditins_ListQuery($id:ID!){
  instructions(id:$id){
    annex{
      name
      url
        ...
        <form className="layui-form"  action="">
          <div className="layui-form-item">
            <div className="layui-inline">
              <label className="layui-form-label" style={{ width: 100 }}><span style={{ color: 'red', marginRight: 4 }}>*</span>是否同意</label>
              <div className="layui-input-block">
                <input type="radio" name="status" value="INSTRUCTIONSTODO_REJECT_OK" title="同意"/>
                <input type="radio" name="status" value="INSTRUCTIONSTODO_REJECT_NOT" title="不同意"/>
              </div>
            </div>
          </div>
          <div className="layui-form-item">
            <div className="layui-inline">
              <label className="layui-form-label" style={{ width: 100 }}>审批内容</label>
              <div className="layui-input-block" style={{ width:'612px' }}>
                <textarea name="rejectReply" placeholder="请输入审批内容" className="layui-textarea"></textarea>
              </div>
            </div>
          </div>
          <div className="layui-form-item">
    ...
    <div style={{ backgroundColor: '#f0f2f5' }}>
      <Card title="" bordered={false} >
        <Breadcrumb style={{ margin: '0px 0px 15px 0px' }}>
          ...
          <Breadcrumb.Item>指令审批</Breadcrumb.Item>
        </Breadcrumb>
      </Card>
      <Divider />
