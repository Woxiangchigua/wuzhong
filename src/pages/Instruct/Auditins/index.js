...
import InsAudit from '../Mutations/InsAudit'
...
const { Option } = Select;
const query = graphql`
query Auditins_ListQuery($id:ID!){
  instructions(id:$id){
    annex{
      name
      url
          ...
          <div className="layui-form-item">
            <div className="layui-inline">
              ...
              <div className="layui-input-block">
                <input type="radio" name="status" value="INSTRUCTIONS_SUBOFFICE_REJECT_OK" title="同意"/>
                <input type="radio" name="status" value="INSTRUCTIONS_SUBOFFICE_REJECT_NOT" title="不同意"/>
              </div>
            </div>
          </div>
          <div className="layui-form-item">
