...
import Policeask from '../Mutations/Policeask'
...
const { Option } = Select;
const query = graphql`
query Policeaskins_ListQuery($id:ID!){
        ...
        <form className="layui-form"  action="">
          <div className="layui-form-item">
            <div className="layui-inline">
              <label className="layui-form-label" style={{ width: 100 }}>请示内容</label>
              <div className="layui-input-block" style={{ width:'612px' }}>
                <textarea name="askFor" placeholder="请输入请示内容" className="layui-textarea"></textarea>
              </div>
            </div>
          </div>
          <div className="layui-form-item">
    ...
    <div style={{ backgroundColor: '#f0f2f5' }}>
      <Card title="" bordered={false} >
        <Breadcrumb style={{ margin: '0px 0px 15px 0px' }}>
          ...
          <Breadcrumb.Item>指令请示</Breadcrumb.Item>
        </Breadcrumb>
      </Card>
      <Divider />
